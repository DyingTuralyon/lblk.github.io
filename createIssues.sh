username="LBLK" # github username
token="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"  # personal access token
repo_name="lblk.github.io" # issues repo
host="https://lblk.github.io" # host url without suffix /
sitemap_path="/sitemap.xml" # sitemap path
post_regex="https://lblk.github.io/post/[-A-Za-z0-9\+&@#/%?=~_|!:,.;]*" # !important, you have to distinguish the posts,
